 ...
 * Run:     ./PFAC.exe raw.txt
 * Run N:   ./PFAC.exe raw.txt 65536
 * Nsight:  nsys profile -o report_pfac --stats=true ./PFAC.exe raw.txt
 */
...
int main(int argc, char *argv[]) {
    ...
    if (alloc_n > 1073741824LL) alloc_n = 1073741824LL;
